...
const EvolutionV1 = ({ currentBalance, handleSearchClick, HideScrollOverflow, DirectFromSearch, loading, GamesOfEvolution }) => {
          ...
          {GamesOfEvolution.map((game) => (
            ...
            <div className="staff_image_holder">
                  ...
                  <span className="spanofc15s265wimg">
                    <img className="abs15x5w6532sdf63sd" src="/Logos/CompanyLogos/evolutoin.png" alt="" />
                    <img className="c15s265wimg" src={game.ImageFullPath} alt={`Image ${game.Trans.en}`} />
                  </span>
                  <div className="dataofgamex">
                    <p className="scksw55x5s">Evolution</p>
            ...
            <div className="popupsdfdselayover">
              <div className="xs48w5sd3225">
                ...
                <h2 className="zx58we65se23s">
                  <img src="/Logos/CompanyLogos/evolutoin.png" alt="" />
                </h2>
